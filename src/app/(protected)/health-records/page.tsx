...
export default function HealthRecordsPage() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <dialog ref={dialogRef} className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-xl backdrop:bg-black/40 max-w-2xl w-full p-0" onCancel={onClose} aria-labelledby="health-record-dialog-title">
        <div className="p-6 space-y-4">
          <div className="flex items-center justify-between">
            <h2 id="health-record-dialog-title" className="text-lg font-semibold text-slate-900 dark:text-white">{editing ? "Edit Health Record" : "Create Health Record"}</h2>
            <button onClick={onClose} className="p-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-500" aria-label="Close dialog">
