...
import { useAllDoctors, useDeleteDoctor, useUpdateDoctor, useVerifyDoctor } from "@/hooks/useDoctorsList";
...
export default function ManageDoctorsPage() {
  const { filters: f, page, set, setMany, setPage, resetAll, activeFilterCount } = useURLFilters(doctorFilters);
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <div className="relative flex-1 min-w-[200px] max-w-xs">
          ...
          <input type="text" placeholder="Search doctors..." value={searchInput} onChange={(e) => setSearchInput(e.target.value)}
        ...
        <select value={specialty} onChange={(e) => setMany({ specialty: e.target.value || undefined })}
                  ...
                  <tr key={d._id} className="border-b border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                    ...
                    <td className="px-4 py-3 text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <button onClick={() => verifyDoctor.mutate({ id: d._id, isVerified: !d.isVerified })}
                        ...
                        >
                          {verifyDoctor.isPending ? <Loader2 className="w-3 h-3 animate-spin" /> : d.isVerified ? "Verified" : "Verify"}
                        </button>
