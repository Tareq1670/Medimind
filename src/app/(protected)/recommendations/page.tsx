      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="card-standard p-6 space-y-5">
            ...
            <div>
              ...
              {healthRecord?.chronicConditions?.length ? (
                <p className="text-xs text-slate-400 mt-1">Auto-filled from your health record. You can add more above.</p>
              ) : null}
            </div>
        ...
        <div className="space-y-4">
          <div className="card-standard p-5">
            ...
            {history.length === 0 ? (
              <p className="text-xs text-slate-400">No previous recommendations yet.</p>
            ) : (
              <div className="space-y-2">
                {history.map((h) => (
                  <button
