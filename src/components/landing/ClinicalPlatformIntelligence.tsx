            ...
            <div className="mt-4 h-[220px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={growthData} margin={{ top: 5, right: 10, left: -10, bottom: 0 }}>
                  ...
                  <XAxis dataKey="month" tick={{ fontSize: 10, fill: chart.tickColor }} axisLine={false} tickLine={false} />
                  <YAxis yAxisId="users" tick={{ fontSize: 10, fill: chart.tickColor }} axisLine={false} tickLine={false} />
                  <YAxis yAxisId="accuracy" orientation="right" domain={[80, 100]} tick={{ fontSize: 10, fill: chart.tickColor }} axisLine={false} tickLine={false} />
                  <Tooltip
                    contentStyle={{
                      borderRadius: "8px",
                      border: `1px solid ${chart.tooltipBorder}`,
