...
const tools = [
  {
    ...
    description: "Describe your symptoms and get instant AI-powered preliminary analysis.",
    icon: HeartPulse,
  ...
  },
  {
    ...
    description: "Browse our comprehensive database of medicines with AI-powered insights.",
    icon: Pill,
  ...
  },
  {
    ...
    description: "Upload lab reports and medical scans for instant AI-powered analysis.",
    icon: ScanSearch,
    color: "from-[#2563EB] to-[#1D4ED8]",
    gradient: "from-[#2563EB]/5 to-[#1D4ED8]/5 dark:from-[#2563EB]/10 dark:to-[#1D4ED8]/10",
    borderGlow: "group-hover:border-[#2563EB]/30",
  },
  {
    href: "/doctors",
    title: "Find Doctor",
    description: "Connect with verified specialists for online or in-person consultations.",
    icon: CalendarCheck,
    color: "from-[#14B8A6] to-[#0D9488]",
    gradient: "from-[#14B8A6]/5 to-[#0D9488]/5 dark:from-[#14B8A6]/10 dark:to-[#0D9488]/10",
    borderGlow: "group-hover:border-[#14B8A6]/30",
